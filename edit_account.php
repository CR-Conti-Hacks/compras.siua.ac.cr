          ...
          <div class="row">
            ...
            <div class="col-md-8">
              ...
              <div class="form-group">
                <input type="file" name="file_upload" multiple="multiple" class="btn btn-default btn-file" style="width:60px"  placeholder="Upload File" value="ddd" />Seleccionar Archivo
              </div>
              <div class="form-group">
