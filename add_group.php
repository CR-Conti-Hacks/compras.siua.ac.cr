...
<?php
  if(isset($_POST['add'])){
   ...
   if(find_by_groupName($_POST['group-name']) == true ){
...
<div class="login-page">
  <div class="text-center">
    <h3 class="tituloEditar">Agregar grupo de usuario</h3>
  </div>
  <br />
  <?php echo display_msg($msg); ?>
    <form method="post" action="add_group.php" class="clearfix">
      ...
      <div class="form-group clearfix" style="text-align: center;">
        <button type="submit" name="add" class="btn btn-compras">Guardar</button>
        <button type="button" class="btn btn-compras" onclick="location.href='group.php'">Regresar</button>
      </div>
    </form>
</div>
